...
export default function UserTableRow({ user, onEdit }) {
  return (
    <tr className="hover:bg-gray-50/50 transition-colors">
      ...
      <td className="px-6 py-4">
        <label
          className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium transition ${user.IsActive ? 'bg-emerald-100 text-emerald-700' : 'bg-red-50 text-red-700'}`}
        >
